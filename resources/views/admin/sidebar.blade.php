<div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="{{asset('admincss/img/PassportSizePhoto.jpg')}}" alt="..." class="img-fluid rounded-circle" ></div>
          <div class="title">
            <h1 class="h5">Ashraful Ahsan</h1>
            <p>Web Developer</p>
          </div>
        </div>
        ...
        <ul class="list-unstyled">
                ...
                <li>
                    <a href="{{ url('view_messege')}}"> <i class="icon-grid"></i>Messeges </a>
                </li>
